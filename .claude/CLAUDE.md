# `docs.go-error` — public documentation repository

This is the **public** documentation site for [`gomatic/go-error`](https://github.com/gomatic/go-error), created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages.
...
- **Keep docs in sync with the source.** When [`gomatic/go-error`](https://github.com/gomatic/go-error)'s API changes, update [`content/`](../content/) to match.
